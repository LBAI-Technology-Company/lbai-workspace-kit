...
description: Deliver (when needed), review, finish, and safely synchronize an LBAI task. Normal employee end command; auto-runs delivery when task_output.md is not ready.
---
...
2. Read the workspace `AGENTS.md`, `lbai_system/runner_contracts/lbai_command_contract_v1.md`, `lbai_system/prompts/execute_task_plan_prompt_v1.md`, `lbai_system/prompts/finish_review_enrichment_prompt_v1.md`, and `lbai_system/schemas/finish_review_enrichment_schema_v1.json`.
...
9. Report `auto_execute`, task status, commit readiness, review reminder, sync status, and exact next step from the command result.
