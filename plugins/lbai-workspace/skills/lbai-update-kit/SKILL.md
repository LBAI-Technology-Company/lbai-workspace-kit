...
1. Run `lbai doctor --json --plugin-version 1.5.0 --min-workspace-version 1.4.1`, but allow `workspace_update_required` to proceed.
...
5. Run `lbai doctor --json --plugin-version 1.5.0 --min-workspace-version 1.4.1` again.
