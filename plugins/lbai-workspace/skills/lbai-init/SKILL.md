...
1. Run `lbai doctor --json --plugin-version 1.4.6 --min-workspace-version 1.4.1`. If the workspace is invalid or incompatible, stop and show the reported next step. Never display credentials.
