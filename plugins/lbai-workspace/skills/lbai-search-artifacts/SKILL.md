...
1. Run `lbai doctor --json --plugin-version 1.4.23 --min-workspace-version 1.4.1 --require-backend`. If backend authentication is missing, stop and direct the user to `lbai auth backend-login`.
